...
public class BilibiliConfig implements IConfig {
    ...
    public static class Danmaku {
        ...
        private String normalStyle = "%{medal}&7[普] &b<%{user}> &f%{danmaku}";

        private transient String normalStyleFormatted = "";

        @SerializedName("guard_style")
        private String guardStyle = "%{medal}&6[舰] &2<%{user}> &f%{danmaku}";

        private transient String guardStyleFormatted = "";

        @SerializedName("admin_style")
        private String adminStyle = "%{medal}&4[房] &d<%{user}> &f%{danmaku}";

        private transient String adminStyleFormatted = "";

        @SerializedName("medal_style")
        private String medalStyle = "[%{medalName} | %{medalLevel}] ";

        private transient String medalStyleFormatted = "";
        ...
        public String getMedalStyleFormatted() {
            return medalStyleFormatted;
        }
        ...
        public Danmaku deco() {
            this.normalStyleFormatted = normalStyle.replaceAll("&([0-9a-fk-or])", "§$1")
                    ...
                    .replaceAll("%\\{medal}", Matcher.quoteReplacement("%3$s"));
            ...
            this.adminStyleFormatted = adminStyle.replaceAll("&([0-9a-fk-or])", "§$1")
                    ...
                    .replaceAll("%\\{danmaku}", Matcher.quoteReplacement("%2$s"))
                    .replaceAll("%\\{medal}", Matcher.quoteReplacement("%3$s"));
            this.medalStyleFormatted = medalStyle.replaceAll("&([0-9a-fk-or])", "§$1")
                    .replaceAll("%\\{medalName}", Matcher.quoteReplacement("%1$s"))
                    .replaceAll("%\\{medalLevel}", Matcher.quoteReplacement("%2$s"));
            return this;
        }
    }
